...
if(isset($_POST["register_button"]))
{
	...
	if($message == '')
	{
		...
		else
		{
			...
			$mail->Username = 'ankitharankithar@gmail.com';  //Here you can use your Gmail Email Address

			$mail->Password = 'rnbwkoxiefldpdpq';  //Here you can use your Gmail Address Password

			$mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;

			$mail->Port = 587;

			$mail->setFrom('ankitharankithar@gmail.com', 'Digital Library');

			$mail->addAddress($formdata['user_email_address'], $formdata['user_name']);

			$mail->isHTML(true);

			$mail->Subject = 'Registration Verification for Digital Library';

			$mail->Body = '
			 <p>Thank you for registering for Digital Library & your Unique ID is <b>'.$user_unique_id.'</b> which will be used for issue book.</p>

                <p>This is a verification email, please click the link to verify your email address.</p>
                <p><a href="'.base_url().'verify.php?code='.$user_verification_code.'">Click to Verify</a></p>
                <p>Thank you...</p>
			';
